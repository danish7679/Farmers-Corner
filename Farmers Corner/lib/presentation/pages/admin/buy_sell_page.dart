...
@RoutePage()
class BuySellPage extends StatefulWidget implements AutoRouteWrapper {
  const BuySellPage({super.key});

  @override
  State<BuySellPage> createState() => _AddMachinePageState();
...
class _AddMachinePageState extends State<BuySellPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Buyer/Seller'),
      ),
      body: FormBuilder(
        key: _formKey,
                    ...
                    BlocConsumer<AddMachineCubit, AddMachineState>(
                      listener: (context, state) {
                        if (state is AddMachineSuccess) {
                          context.showSuccessBar(
                              content:
                                  const Text('Buyer/Seller added successfully'));
                      ...
                      builder: (context, state) {
                        return PrimaryButton(
                          ...
                          child: const Text('Add Buyer/Seller'),
                          onPressed: () {
